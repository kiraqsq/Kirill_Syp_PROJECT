module WorkImage
    ...
    # Отображение изображения по индексу для заданной темы
    def show_image(theme_id, image_index)
      # Получаем изображения для заданной темы
      ...
      # Получаем атрибуты одного изображения
      ...
      # Проверяем, оценил ли пользователь изображение
      ...
      # Получаем количество всех оценок
      values_qty = Value.all.count.round
  
      # Вычисляем среднее значение оценок для данного изображения
      if user_valued == 1
      ...
      # Формируем хэш данных об изображении
      data = {
        index: image_index,
